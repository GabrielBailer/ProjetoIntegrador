...
fun configurarAbasConfiguracao(view: View) {
    ...
    fun selecionarAbaAparencia() {
        ...
        // Descrição
        tvDescricaoConfiguracao.text =
            "O modo escuro reduz o brilho da tela e pode ajudar a diminuir o cansaço visual, especialmente em ambientes com pouca luz."

        // Movimentação do Indicador
        indicadorTab.post {
            indicadorTab.animate()
                .x(tabAparencia.x)
                .setDuration(200)
                .start()
    ...
    fun selecionarAbaSeguranca() {
        ...
        // Descrição - CORREÇÃO AQUI: removido 'val' e adicionado '.text ='
        tvDescricaoConfiguracao.text =
            "O modo responsável exige a senha do responsável para autorizar a inclusão de novas interações."
    ...
    // Inicializa na aba de Aparência
